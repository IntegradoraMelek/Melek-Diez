    ...
    <div class="card-deck text-center">
      <div class="card shadow bg-white rounded">
        ...
        <div class="card-body">
          ...
          <form action="catalogo2.php">
          <button class="btn btn-outline-primary btn-block">Catálogos</button>
          </form>
          
           <hr>
           <form action="pedidos.php">
          <button id="btnpedido6" class="btn btn-outline-success btn-block">Pedidos</button>
      </form>
        </div>
      </div>
      <div class="card shadow bg-white rounded">
        ...
        <div class="card-body">
          ...
          <button class="btn btn-outline-primary btn-block">Catálogos</button>
           ...
           <hr>
           <form action="pedidos.php">
          <button id="btnpedido5" class="btn btn-outline-success btn-block">Pedidos</button>
          </form>
        </div>
      </div>
      <div class="card shadow bg-white rounded hoverable">
        ...
        <div class="card-body">
          ...
          <button class="btn btn-outline-primary btn-block">Catálogos</button>
           ...
           <hr>
           <form action="pedidos.php">
          <button id="btnpedido4" class="btn btn-outline-success btn-block">Pedidos</button>
      </form>
        </div>
      </div>
    </div>
      ...
      <div class="card shadow bg-white rounded hoverable">
        ...
        <div class="card-body">
          ...
          <button class="btn btn-outline-primary btn-block">Catálogos</button>
           ...
           <hr>
           <form action="pedidos.php">
          <button id="btnpedido3" class="btn btn-outline-success btn-block">Pedidos</button>
      </form>
        </div>
      </div>
      <div class="card shadow bg-white rounded hoverable">
        ...
        <div class="card-body">
          ...
          <button class="btn btn-outline-primary btn-block">Catálogos</button>
           ...
           <hr>
           <form action="pedidos.php">
          <button id="btnpedido2" class="btn btn-outline-success btn-block">Pedidos</button>
      </form>
        </div>
      </div>
      <div class="card shadow bg-white rounded hoverable">
        ...
        <form action="catalogo2.php">
          <button class="btn btn-outline-primary btn-block">Catálogos</button>
           ...
           <hr>
           <form action="pedidos.php">
          <button id="btnpedido" class="btn btn-outline-success btn-block">Pedidos</button>
      </form>
        </div>
      </div>
    </div>
