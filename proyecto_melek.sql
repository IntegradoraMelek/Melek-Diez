...
DELIMITER $$
create procedure insertar(nombre varchar(40),correo_electronico varchar(50),telefono varchar(10),direccion varchar(150),contraseña varchar(30))
begin
insert into usuario(nombre,correo_electronico,telefono,direccion,contraseña)
values(nombre,correo_electronico,telefono,direccion,contraseña);
end $$
DELIMITER $$ 